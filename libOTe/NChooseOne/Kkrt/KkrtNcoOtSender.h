...
public:
    ...
    // @ chl: not used.
    void setBaseOts(gsl::span<block> baseRecvOts, const BitVector& choices, Channel& chl) override
    {
        setBaseOts(baseRecvOts, choices);
    }

    // See other setBaseOts(...).
    void setBaseOts(gsl::span<block> baseRecvOts, const BitVector& choices);
    ...
    void encode(u64 otIdx, const void* choice, void* dest, u64 destSize) override;
    // void encode(u64 otIdx, const void* input, void* dest, u64 destSize, u64 key);
