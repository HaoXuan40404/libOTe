...
class OosNcoOtSender : public NcoOtExtSender, public TimerAdapter
{
public:
    LinearCode mCode;
    u64 mStatSecParam = 0;
    ...
    void setBaseOts(span<block> baseRecvOts, const BitVector& choices, Channel& chl) override;
    ...
    void encode(u64 otIdx, const void* codeWord, void* dest, u64 destSize) override;
    ...
    void setUniformBaseOts(span<block> baseRecvOts, const BitVector& choices);
};
}  // namespace osuCrypto
