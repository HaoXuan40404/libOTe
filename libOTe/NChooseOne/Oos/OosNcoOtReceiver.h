...
class OosNcoOtReceiver : public NcoOtExtReceiver, public TimerAdapter
{
public:
    ...
    OosNcoOtReceiver(OosNcoOtReceiver&& v) { *this = std::forward<OosNcoOtReceiver>(v); }
    ...
    void encode(u64 otIdx, const void* inputword, void* dest, u64 destSize) override;
