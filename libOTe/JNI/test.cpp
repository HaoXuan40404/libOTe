...
std::cout << "wedpr_kkrt_aes_enc_test" << std::endl;
    // osuCrypto::u64 choiceCount = 2;  // Messages.rows()
    // osuCrypto::u64 msgCount = 500;   // Messages.cols()
    ...
    for (osuCrypto::u64 i = 0; i < msgCount; i++)
    {
        ...
        // we test true message osuCrypto::block length is 2
    ...
    // just show how to encode and decode osuCrypto::block
