...
//    /// X^64 + X^4 + X^3 + X + 1
//    /// 0x1b
alignas(32) const uint64_t _gf2ext64_reducer[4] = {
    0x415A776C2D361B00ULL, 0x1bULL, 0x415A776C2D361B00ULL, 0x1bULL};

inline __m128i _gf2ext64_reduce_sse(__m128i x0)
{
...
inline __m128i _gf2ext64_reduce_x2_sse(__m128i x0, __m128i y0)
{
    __m128i reducer = _mm_load_si128((__m128i const*)_gf2ext64_reducer);
    //__m128i *reducer = (__m128i *)_gf2ext128_reducer;
    __m128i r0 = _mm_clmulepi64_si128(x0, reducer, 0x11);
...
//
inline __m256i _gf2ext64_reduce_x4_avx2(__m128i w0, __m128i x0, __m128i y0, __m128i z0)
{
...
//
inline __m128i _gf2ext64_mul_hi_sse(__m128i a0, __m128i b0)
{
...
inline __m128i _gf2ext64_mul_2x1_sse(__m128i a0a1, __m128i b0)
{
...
inline __m256i _gf2ext64_mul_4x1_avx2(__m256i a, __m128i b0)
{
...
inline __m256i _gf2ext64_mul_4x4_avx2(__m256i a, __m256i b)
{
    __m128i al = _mm256_castsi256_si128(a);
...
inline void gf2ext64_mul_4x4_avx2(uint8_t* c, const uint8_t* a, const uint8_t* b)
{
...
// USED;
inline __m128i _gf2ext128_reduce_sse(__m128i x0, __m128i x128)
{
    ...
    x0 = _mm_xor_si128(x0, _mm_shuffle_epi32(x64, 0x4f));      // xx1 , xx0 , 0 , 0   ;  0x4f -->
                                                               // 1,0,3,3  --> xx1,xx0,0,0
...
// USED;
inline void gf2ext128_mul_sse(uint8_t* c, const uint8_t* a, const uint8_t* b)
{
...
inline __m128i _gf2ext128_mul_sse(__m128i a0, __m128i b0)
{
    __m128i c0, c128;
    _MUL_128_KARATSUBA(c0, c128, a0, b0);
    __m128i c3 = _gf2ext128_reduce_sse(c0, c128);
...
inline __m256i _gf2ext128_mul_2x1_avx2(__m256i a0a1, __m128i b0)
{
...
inline __m256i div_s7(__m256i a)
{
...
// USED;
inline __m256i exp_s7(__m256i a)
{
    __m128i r_s7 = _mm_load_si128((__m128i const*)_s7);
    __m128i a1 = _mm256_extracti128_si256(a, 1);
    __m128i a0 = _mm256_castsi256_si128(a);
