...
namespace bpm
{
inline __m128i bitmat_prod_accu_64x128_M8R_sse(__m128i r0, const uint64_t* mat4R, uint64_t a)
{
...
inline void bitmatrix_prod_64x128_8R_sse(uint8_t* r, const uint64_t* mat4R, uint64_t a)
{
...
// USED;
inline void bitmatrix_prod_128x128_4R_b32_opt_avx2(
    uint8_t* r32, const uint64_t* matB4R, const uint8_t* a32)
{
    ...
    for (unsigned i = 0; i < 16; i++)
    {
        ...
        for (unsigned j = 0; j < 8; j++)
        {
            ...
            r[j] = _mm256_xor_si256(_mm256_xor_si256(r[j], _mm256_shuffle_epi8(tab_0, low1_low0)),
                _mm256_shuffle_epi8(tab_1, high1_high0));
        }
    }
    tab += 16 * 16;
    r += 8;
...
// USED;
inline void bitmatrix_prod_64x128_4R_b32_opt_avx2(
    uint8_t* r128_32, const uint64_t* matB4R, const uint8_t* a64_32)
{
    alignas(32) uint8_t t32[32 * 8];
    /// 0x10,0x11,0x12,.....0x2f
    transpose_8x8_b4_avx2(t32, a64_32);
    /// bitsliced: 0x10,0x14,0x18,0x1c, 0x20,0x24,0x28,0x2c, 0x11,0x15,0x19,0x1d,
    /// 0x21,0x25,0x29,0x2d, |
    ///            0x12,0x16,0x1a,0x1e, 0x22,0x26,0x2a,0x2e, 0x13,0x17,0x1b,0x1f,
    ///            0x23,0x27,0x2b,0x2f,
...
inline void bitmatrix_prod_64x64_4R_b64_avx2(
    uint8_t* r128_32, const uint64_t* matB4R, const uint8_t* a64_32)
{
#if 0
    ...
    {  ///
        ...
        r0 = _mm256_xor_si256(_mm256_xor_si256(r0, _mm256_shuffle_epi8(tab_0, _0_low1_low0)),
            _mm256_shuffle_epi8(tab_1, _0_high1_high0));
        r4 = _mm256_xor_si256(_mm256_xor_si256(r4, _mm256_shuffle_epi8(tab_0, _1_low1_low0)),
            _mm256_shuffle_epi8(tab_1, _1_high1_high0));
        tab_0 = tab[i * 16 + 2];
        tab_1 = tab[i * 16 + 3];
        r1 = _mm256_xor_si256(_mm256_xor_si256(r1, _mm256_shuffle_epi8(tab_0, _0_low1_low0)),
            _mm256_shuffle_epi8(tab_1, _0_high1_high0));
        r5 = _mm256_xor_si256(_mm256_xor_si256(r5, _mm256_shuffle_epi8(tab_0, _1_low1_low0)),
            _mm256_shuffle_epi8(tab_1, _1_high1_high0));
        tab_0 = tab[i * 16 + 4];
        tab_1 = tab[i * 16 + 5];
        r2 = _mm256_xor_si256(_mm256_xor_si256(r2, _mm256_shuffle_epi8(tab_0, _0_low1_low0)),
            _mm256_shuffle_epi8(tab_1, _0_high1_high0));
        r6 = _mm256_xor_si256(_mm256_xor_si256(r6, _mm256_shuffle_epi8(tab_0, _1_low1_low0)),
            _mm256_shuffle_epi8(tab_1, _1_high1_high0));
        tab_0 = tab[i * 16 + 6];
        tab_1 = tab[i * 16 + 7];
        r3 = _mm256_xor_si256(_mm256_xor_si256(r3, _mm256_shuffle_epi8(tab_0, _0_low1_low0)),
            _mm256_shuffle_epi8(tab_1, _0_high1_high0));
        r7 = _mm256_xor_si256(_mm256_xor_si256(r7, _mm256_shuffle_epi8(tab_0, _1_low1_low0)),
            _mm256_shuffle_epi8(tab_1, _1_high1_high0));
    }
...
inline void bitmatrix_prod_64x64_h32zero_4R_b64_avx2(
    uint8_t* r128_32, const uint64_t* matB4R, const uint8_t* a64_32)
{
    alignas(32) uint8_t t32[32 * 8];
    ...
    {  ///
        ...
        r0 = _mm256_xor_si256(_mm256_xor_si256(r0, _mm256_shuffle_epi8(tab_0, low1_low0)),
            _mm256_shuffle_epi8(tab_1, high1_high0));
        r4 = _mm256_xor_si256(_mm256_xor_si256(r4, _mm256_shuffle_epi8(tab_0, _low1_low0)),
            _mm256_shuffle_epi8(tab_1, _high1_high0));
        tab_0 = tab[i * 16 + 1 * 2];
        tab_1 = tab[i * 16 + 1 * 2 + 1];
        r1 = _mm256_xor_si256(_mm256_xor_si256(r1, _mm256_shuffle_epi8(tab_0, low1_low0)),
            _mm256_shuffle_epi8(tab_1, high1_high0));
        r5 = _mm256_xor_si256(_mm256_xor_si256(r5, _mm256_shuffle_epi8(tab_0, _low1_low0)),
            _mm256_shuffle_epi8(tab_1, _high1_high0));
        tab_0 = tab[i * 16 + 2 * 2];
        tab_1 = tab[i * 16 + 2 * 2 + 1];
        r2 = _mm256_xor_si256(_mm256_xor_si256(r2, _mm256_shuffle_epi8(tab_0, low1_low0)),
            _mm256_shuffle_epi8(tab_1, high1_high0));
        r6 = _mm256_xor_si256(_mm256_xor_si256(r6, _mm256_shuffle_epi8(tab_0, _low1_low0)),
            _mm256_shuffle_epi8(tab_1, _high1_high0));
        tab_0 = tab[i * 16 + 3 * 2];
        tab_1 = tab[i * 16 + 3 * 2 + 1];
        r3 = _mm256_xor_si256(_mm256_xor_si256(r3, _mm256_shuffle_epi8(tab_0, low1_low0)),
            _mm256_shuffle_epi8(tab_1, high1_high0));
        r7 = _mm256_xor_si256(_mm256_xor_si256(r7, _mm256_shuffle_epi8(tab_0, _low1_low0)),
            _mm256_shuffle_epi8(tab_1, _high1_high0));
    }
