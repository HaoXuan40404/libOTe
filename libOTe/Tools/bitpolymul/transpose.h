...
namespace bpm
{
alignas(32) const uint8_t _tr_4x4[32] = {0, 4, 8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 11, 15, 0, 4,
    8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 11, 15};

// USED;
inline void tr_avx2_4x4_b8(uint8_t* _r, const uint8_t* a)
{
...
// USED;
inline void tr_16x16_b2_from_4x4_b8_1_4(uint8_t* r, const uint8_t* a)
{
...
// USED;
inline void tr_16x16_b2_avx2(uint8_t* r, const uint8_t* a)
{
    alignas(32) uint8_t temp[32 * 16];
    for (unsigned i = 0; i < 4; i++)
        tr_avx2_4x4_b8(temp + i * 32 * 4, a + i * 32 * 4);
...
// USED;
inline void tr_8x8_b4_avx2(uint8_t* _r, const uint8_t* a, const uint64_t mem_len)
{
    /// code of 4x4_b8
    __m256i r0 = _mm256_load_si256((__m256i*)a);
...
// USED;
inline void transpose_8x8_b4_avx2(uint8_t* _r, const uint8_t* a)
{
#if 0
...
inline void transpose_8x8_h4zero_b4_avx2(uint8_t* _r, const uint8_t* a)
{
    __m256i a0 = _mm256_load_si256((__m256i*)a);
    __m256i a1 = _mm256_load_si256((__m256i*)(a + 32 * 1));
    __m256i a2 = _mm256_load_si256((__m256i*)(a + 32 * 2));
...
// USED;
inline void tr_bit_8x8_b32_avx2(uint8_t* _r, const uint8_t* a)
{
...
// USED;
inline void tr_bit_64x64_b4_avx2(uint8_t* _r, const uint8_t* a)
{
    for (unsigned i = 0; i < 8; i++)
    {
...
// USED;
inline void tr_bit_128x128_b2_avx2(uint8_t* _r, const uint8_t* a)
{
