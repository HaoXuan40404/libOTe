...
{
// USED;
inline __m128i gf_isomorphism_single_bit(u64 ith_bit)
{
    return _mm_load_si128((__m128i*)(&gfCantorto2128[ith_bit]));
}

// USED;
inline __m128i gf_isomorphism(uint64_t a_in_cantor)
{
...
// USED;
inline __m128i butterfly(__m128i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
...
// USED;
inline __m128i butterfly_avx2(__m256i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
    a = xor128(a, gf_isomorphism(ska));
...
// USED;
inline __m128i butterfly_avx2_b2(__m256i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
    a = xor128(a, gf_isomorphism(ska));
...
// USED;
inline __m128i butterfly_avx2_b4(__m256i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
    a = xor128(a, gf_isomorphism(ska));
...
inline __m128i i_butterfly(__m128i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
    a = xor128(a, gf_isomorphism(ska));
...
inline __m128i i_butterfly_avx2(__m256i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
    a = xor128(a, gf_isomorphism(ska));
...
inline __m128i i_butterfly_avx2_b2(__m256i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
    a = xor128(a, gf_isomorphism(ska));
...
// USED;
inline __m128i i_butterfly_avx2_b4(__m256i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
    a = xor128(a, gf_isomorphism(ska));
...
// USED;
inline void __btfy(uint64_t* fx, u64 st_unit_size, u64 offset, u64 n_terms, u64 scalar_a)
{
    u64 i = st_unit_size;
    ...
    for (; i > 3; i--)
    {
        ...
        u64 k = i - 1;
        __m128i extra_a = (scalar_a > k) ? gf_isomorphism_single_bit((scalar_a - k - 1) << 1) :
                                           _mm_setzero_si128();
...
inline void __i_btfy(uint64_t* fx, u64 end_unit_size, u64 offset, u64 n_terms, u64 scalar_a)
{
    u64 i = 1;
    __m128i* poly128 = (__m128i*)&fx[0];
    for (; i < 2; i++)
...
void i_btfy_128(uint64_t* fx, u64 n_fx, u64 scalar_a)
{
...

    {
        ...
        for (u64 j = 0; j < num; j++)
        {
            __i_btfy(fx, _LOG_CACHE_SIZE_, j * unit, unit, scalar_a);
        };
    }
    __m256i* poly256 = (__m256i*)&fx[0];
...
inline __m128i gf264_isomorphism_single_bit(u64 ith_bit)
{
    return _mm_load_si128((__m128i*)(&gfCantorto264[ith_bit << 1]));
}

inline __m128i gf264_isomorphism(uint64_t a_in_cantor)
{
    alignas(32) uint8_t a_iso[16];
...
inline __m128i butterfly_64_xmm(__m128i d, __m128i a)
{
...
inline __m128i i_butterfly_64_xmm(__m128i d, __m128i a)
{
...
inline __m128i butterfly_64_u2(__m128i* poly, u64 ska, __m128i extra_a)  /// unit = 2>>1
{
    __m128i a = extra_a;
...
inline __m128i i_butterfly_64_u2(__m128i* poly, u64 ska, __m128i extra_a)  /// unit = 2>>1
{
    __m128i a = extra_a;
    a = xor128(a, gf264_isomorphism(ska));
...
inline __m256i butterfly_64_ymm(__m256i d, __m128i a)
{
...
inline __m256i i_butterfly_64_ymm(__m256i d, __m128i a)
{
    __m128i d0 = _mm256_castsi256_si128(d);
    __m128i d1 = _mm256_extracti128_si256(d, 1);
    d1 = xor128(d1, d0);
...
inline __m128i butterfly_64_u4(__m256i* poly, u64 ska, __m128i extra_a)  /// unit = 4>>2
{
    __m128i a = extra_a;
    a = xor128(a, gf264_isomorphism(ska));
...
inline __m128i i_butterfly_64_u4(__m256i* poly, u64 ska, __m128i extra_a)  /// unit = 4>>2
{
    __m128i a = extra_a;
    a = xor128(a, gf264_isomorphism(ska));
...
inline __m128i butterfly_64_avx2(__m256i* poly, u64 unit, u64 ska, __m128i extra_a)  /// unit >=
                                                                                     /// 8>>2
{
    __m128i a = extra_a;
    a = xor128(a, gf264_isomorphism(ska));
...
inline __m128i butterfly_64_avx2_b2(__m256i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
    a = xor128(a, gf264_isomorphism(ska));
...
inline __m128i butterfly_64_avx2_b4(__m256i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
    a = xor128(a, gf264_isomorphism(ska));
...
inline __m128i i_butterfly_64_avx2(__m256i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
    a = xor128(a, gf264_isomorphism(ska));
...
inline __m128i i_butterfly_64_avx2_b2(__m256i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
    a = xor128(a, gf264_isomorphism(ska));
...
inline __m128i i_butterfly_64_avx2_b4(__m256i* poly, u64 unit, u64 ska, __m128i extra_a)
{
    __m128i a = extra_a;
    a = xor128(a, gf264_isomorphism(ska));
...
void btfy_64(uint64_t* fx, u64 n_fx, u64 scalar_a)
{
    ...
    for (; i > 4; i--)
    {
        ...
        u64 k = i - 1;
        __m128i extra_a =
            (scalar_a > k) ? gf264_isomorphism_single_bit(scalar_a - k - 1) : _mm_setzero_si128();
        ...
        for (u64 j = 0; j < num; j++)
        {
            ...
            last_j = j;
            extra_a =
                butterfly_64_avx2_b4((__m256i*)(poly + j * unit), unit >> 2, diff_j << 1, extra_a);
        }
    }
    for (; i > 3; i--)
    {
        ...
        for (u64 j = 0; j < num; j++)
        {
            ...
            last_j = j;
            extra_a =
                butterfly_64_avx2_b2((__m256i*)(poly + j * unit), unit >> 2, diff_j << 1, extra_a);
        }
    }
    for (; i > 2; i--)
    {
        ...
        for (u64 j = 0; j < num; j++)
        {
            ...
            last_j = j;
            extra_a =
                butterfly_64_avx2((__m256i*)(poly + j * unit), unit >> 2, diff_j << 1, extra_a);
        }
    }
    for (; i > 1; i--)
    {
...
void i_btfy_64(uint64_t* fx, u64 n_fx, u64 scalar_a)
{
    ...
    for (; i < 4; i++)
    {
        ...
        for (u64 j = 0; j < num; j++)
        {
            ...
            last_j = j;
            extra_a =
                i_butterfly_64_avx2((__m256i*)(poly + j * unit), unit >> 2, diff_j << 1, extra_a);
        }
    }
    for (; i < 5; i++)
    {
        ...
        for (u64 j = 0; j < num; j++)
        {
            u64 diff_j = j ^ last_j;
            last_j = j;
            extra_a = i_butterfly_64_avx2_b2(
                (__m256i*)(poly + j * unit), unit >> 2, diff_j << 1, extra_a);
        }
    }
    for (; i <= log_n; i++)
    {
        ...
        for (u64 j = 0; j < num; j++)
        {
            u64 diff_j = j ^ last_j;
            last_j = j;
            extra_a = i_butterfly_64_avx2_b4(
                (__m256i*)(poly + j * unit), unit >> 2, diff_j << 1, extra_a);
        }
    }
}
