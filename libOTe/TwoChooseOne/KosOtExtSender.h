...
namespace osuCrypto
{
class KosOtExtSender : public OtExtSender, public TimerAdapter
{
public:
    ...
    KosOtExtSender(SetUniformOts, span<block> baseRecvOts, const BitVector& choices);
    ...
    void setBaseOts(span<block> baseRecvOts, const BitVector& choices, Channel&) override;
