...
public:
    ...
    void send(span<std::array<block, 2>> messages, PRNG& prng, Channel& sock, u64 numThreads);
    ...
    void send(span<std::array<block, 2>> messages, PRNG& prng, Channel& sock) override
    {
