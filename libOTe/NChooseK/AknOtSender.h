...
public:
    ...
    void init(u64 totalOTCount, u64 cutAndChooseThreshold, double p, OtExtSender& ots, Channel& chl,
        PRNG& prng)
    {
    ...
    void init(u64 totalOTCount, u64 cutAndChooseThreshold, double p, OtExtSender& ots,
