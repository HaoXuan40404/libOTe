...
void polyvec_pointwise_acc_k2(poly* r, const polyvec* a, const polyvec* b) asm(
    "polyvec_pointwise_acc_k2");
void polyvec_pointwise_acc_k3(poly* r, const polyvec* a, const polyvec* b) asm(
    "polyvec_pointwise_acc_k3");
void polyvec_pointwise_acc_k4(poly* r, const polyvec* a, const polyvec* b) asm(
